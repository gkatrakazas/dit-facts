...
export const admissionTypeDescriptions = {
  CIV: "CIVIS",
  ΑΓΝ: "ΑΓΝΩΣΤΟΣ ΚΩΔΙΚΟΣ",
  ΑΔΣ: "ΑΠΟΦΑΣΗ Δ.Σ. ΤΟΥ ΤΜΗΜΑΤΟΣ",
  ΑΘΑ: "ΩΣ ΑΘΛΗΤΗΣ",
  ΑΘΓ: "ΩΣ ΑΘΛΗΤΡΙΑ",
  ΑΘΛ: "ΑΘΛΗΤΕΣ",
  ΑΚΑ: "ΑΛΛΟΓΕΝΕΙΣ ΑΛΛΟΔΑΠΟΙ ΚΟΙΝΟΤ. ΥΠΟΤΡΟΦΟΙ",
  ΑΛΑ: "ΩΣ ΑΛΛΟΔΑΠΟΣ",
  ΑΛΓ: "ΩΣ ΑΛΛΟΔΑΠΗ",
  ΑΛΕ: "ΑΠΟΦΟΙΤΟΙ ΛΥΚΕΙΩΝ ΕΞΩΤΕΡΙΚΟΥ",
  ΑΛΚ: "ΑΛΛΑΓΗ ΚΑΤΕΥΘΥΝΣΗΣ",
  ΑΛΣ: "ΑΛΛΟΔΑΠΟΣ(-Η) Σ.Α.Ν.",
  ΑΜΕ: "ΑΝΑΔΡ.ΕΓΚΡ. ΜΕΤΕΓΓΡΑΦΗΣ ΑΠΟ Γ.Σ.",
  ΑΥΑ: "ΩΣ ΑΛΛΟΔΑΠΟΣ ΥΠΟΤΡΟΦΟΣ",
  ΑΥΓ: "ΩΣ ΑΛΛΟΔΑΠΗ ΥΠΟΤΡΟΦΟΣ",
  ΔΘΑ: "ΔΙΕΘΝΕΙΣ ΑΝΤΑΛΛΑΓΕΣ/ERASMUS",
  ΔΘΣ: "ΔΙΕΘΝΕΙΣ ΣΥΝΕΡΓΑΣΙΕΣ",
  ΔΙΚ: "ΚΑΤΑΤΑΞΗ ΔΙΚΑΤΣΑ  - ΔΟΑΤΑΠ",
  ΔΙΚ2: "ΚΑΤΑΤΑΞΗ ΔΙΚΑΤΣΑ",
  ΕΑΦ: "ΕΠΑΝΕΓΓΡΑΦΗ ΜΕΤΑ ΑΠΟ ΑΠΟΦΟΙΤΗΡΙΟ",
  ΕΓΕ: "ΕΝΤΑΞΗ ΣΤΟ Γ ΕΞΑΜΗΝΟ (ΑΠΟΦ.ΣΥΓΚΛΗΤΟΥ)",
  ΕΓΣ: "ΕΠΑΝΕΓΓΡΑΦΗ (ΑΠΟΦ. ΓΕΝ. ΣΥΝΕΛΕΥΣΗΣ)",
  ΕΕΠ: "ΕΝΤΑΞΗ ΑΠΟ ΕΙΔΙΚΑ ΠΡΟΓΡΑΜΜΑΤΑ",
  ΕΙΔ: "ΕΙΔΙΚΕΣ ΑΝΑΓΚΕΣ",
  ΕΙΠ: "ΕΙΔΙΚΕΣ ΠΕΡΙΠΤΩΣΕΙΣ",
  ΕΚΛ: "ΑΝΩΤΕΡΕΣ ΕΚΚΛΗΣΙΑΣΤΙΚΕΣ ΣΧΟΛΕΣ",
  ΕΞΑ: "ΩΣ ΕΛΛΗΝΑΣ ΕΞΩΤΕΡΙΚΟΥ",
  ΕΞΓ: "ΩΣ ΕΛΛΗΝΙΔΑ ΕΞΩΤΕΡΙΚΟΥ",
  ΕΞΟ: "ΕΞΟΜΟΙΩΣΗ ΠΤΥΧΙΟΥ ΠΑΙΔΑΓΩΓΙΚΩΝ ΑΚΑΔΗΜΙΩΝ",
  ...
  ΕΠΕ: "ΥΠΟΥΡΓΙΚΗ ΑΠΟΦΑΣΗ Φ.253/Β6/755/30-5-2000",
  ΕΠΖ: "ΥΠΟΥΡΓΙΚΗ ΑΠΟΦΑΣΗ ΕΣΩΤ.Φ.25225/Β6/200/6-4-00",
  ΕΠΗ: "ΚΑΘ΄ ΥΠΕΡΒ.Φ151/20049/Β6 ΦΕΚ 156-Α/04.09.09",
  ΕΠΘ: "ΥΠΟΥΡΓΙΚΗ ΑΠΟΦΑΣΗ Φ.152/Β6/198/2000Ν.3794/4.9.2009",
  ΕΠΞ: "ΕΠΑΝΕΝΤΑΞΗ ΣΕ ΝΕΟ ΠΡΟΓΡΑΜΜΑ (ΕΞΑΜΗΝΑ)",
  ΕΠΥ: "ΚΑΘ΄ ΥΠΕΡΒΑΣΗ 5%",
  ΕΠΦ: "ΚΑΘ' ΥΠΕΡΒΑΣΗ ΛΟΓΩ ΦΥΣΙΚΩΝ ΚΑΤΑΣΤΡΟΦΩΝ",
  ΕΣΚ: "ΕΣΩΤΕΡΙΚΗ ΚΙΝΗΤΙΚΟΤΗΤΑ",
  ΚΑΕ: "ΚΑΤΑΤΑΞΗ ΠΤΥΧΙΟΥΧΟΥ ΑΕΙ",
  ΚΑΤ: "ΚΑΤΑΤΑΚΤΗΡΙΕΣ",
  ΚΒΑ: "ΚΑΤΑΤΑΞΗ ΜΕ BATCHELOR",
  ΚΔΕ: "ΚΑΤΑΤΑΞΗ ΔΙΕΤΟΥΣ",
  ΚΔΙ: "ΚΑΤΑΤΑΞΗ ΔΙ.ΚΑ.ΤΣΑ.",
  ΚΜΑ: "ΚΑΤΑΤΑΞΗ ΜΕ MASTER",
  ΚΞΠ: "ΚΑΤΟΧΟΣ ΤΙΤΛΩΝ ΣΠΟΥΔΩΝ ΞΕΝΩΝ ΠΑΝΕΠΙΣΤΗΜΙΩΝ",
  ΚΟΑ: "ΚΟΙΝΟΤΙΚΟΙ ΑΛΛΟΔΑΠΟΙ",
  ΚΠΤ: "ΚΑΤΑΤΑΞΗ ΠΤΥΧΙΟΥΧΟΥ ΑΕΙ-ΤΕΙ",
  ΚΤΔ: "ΚΑΤΑΤΑΞΗ ΠΤΥΧΙΟΥΧΟΥ ΔΡΑΜΑΤΙΚΗΣ ΣΧΟΛΗΣ",
  ΚΤΕ: "ΚΑΤΑΤΑΞΗ ΠΤΥΧΙΟΥΧΟΥ ΤΕΙ",
  ΚΥΑ: "ΩΣ ΚΥΠΡΙΟΣ",
  ΚΥΓ: "ΩΣ ΚΥΠΡΙΑ",
  ΚΥΠ: "ΚΥΠΡΙΟΙ",
  ΚΩΦ: "ΚΩΦΑΛΑΛΟΙ",
  ΛΥΓ: "ΛΟΓΟΙ ΥΓΕΙΑΣ - ΑΝΕΥ ΕΞΕΤΑΣΕΩΝ",
  ΜΑΒ: "ΔΙΑΚΡΙΣΗ ΣΕ ΕΠΙΣΤΗΜΟΝΙΚΕΣ ΟΛΥΜΠΙΑΔΕΣ",
  ΜΑΓ: "ΜΕΤΕΓΓΡΑΦΗ ΛΟΓΩ ΑΠΩΛΕΙΑΣ ΓΟΝΕΑ",
  ΜΑΘ: "ΜΑΘΗΜΑΤΙΚΗ ΟΛΥΜΠΙΑΔΑ",
  ΜΑΝ: "ΜΕΣΟΓΕΙΑΚΗ ΑΝΑΙΜΙΑ",
  ΜΕΑ: "ΜΕΤΕΓΓΡΑΦΗ ΑΘΛΗΤΗ",
  ΜΕΞ: "ΜΕΤΕΓΓΡΑΦΗ ΕΞΩΤΕΡΙΚΟΥ",
  ΜΕΣ: "ΜΕΤΕΓΓΡΑΦΗ ΕΣΩΤΕΡΙΚΟΥ",
  ΜΕΤ: "ΑΠΟ ΜΕΤΕΓΓΡΑΦΗ",
  ΜΘΓ: "ΜΕΤΕΓΓΡΑΦΗ ΛΟΓΩ ΑΣΘΕΝΕΙΑΣ ΓΟΝΕΑ",
  ΜΘΡ: "ΜΟΥΣΟΥΛΜΑΝΟΙ ΘΡΑΚΗΣ",
  ΜΙΣ: "ΜΕΤΕΓΓΡΑΦΗ ΙΣΟΒΑΘΜΙΣΑΝΤΩΝ",
  ΜΚΥ: "ΜΕΤΕΓΓΡΑΦΗ ΑΠΟ ΚΥΠΡΟ",
  ΜΛΑ: "ΜΕΤΕΓΓΡΑΦΗ ΛΟΓΩ ΦΟΙΤΟΥΝΤΟΣ ΑΔΕΛΦΟΥ",
  ΜΛΓ: "ΜΕΤΕΓΓΡΑΦΗ ΛΟΓΩ ΦΟΙΤΟΥΝΤΟΣ ΓΟΝΕΑ",
  ΜΛΘ: "ΜΕΤΕΓΓΡΑΦΗ ΛΟΓΩ ΑΣΘΕΝΕΙΑΣ",
  ΜΛΜ: "ΜΕΤΕΓΓΡΑΦΗ ΩΣ ΜΗΤΕΡΑ ΑΝΗΛΙΚΩΝ",
  ΜΛΣ: "ΜΕΤΕΓΓΡΑΦΗ ΛΟΓΩ ΦΟΙΤΟΥΝΤΟΣ ΣΥΖΥΓΟΥ",
  ΜΟΡ: "ΜΕΤΕΓΓΡΑΦΗ ΒΑΣΕΙ Ν3282/04 (ΩΣ ΟΡΦΑΝΟ ΤΕΚΝΟ)",
  ΜΤΘ: "ΜΕΤΑΦΟΡΑ ΘΕΣΗΣ",
  ΜΤΛ: "ΜΕΤΕΓΓΡΑΦΗ ΩΣ ΤΕΚΝΟ ΠΟΛΥΜΕΛΟΥΣ ΟΙΚΟΓΕΝΕΙΑΣ",
  ΜΤΠ: "ΜΕΤΕΓΓΡΑΦΗ ΩΣ ΤΕΚΝΟ ΠΟΛΥΤΕΚΝΩΝ",
  Ν2640: "Ν.2640/98",
  Ν3763: "Ν.3763/2009",
  Ν3794: "Ν.3794/09",
  ΟΜΟ: "ΩΣ ΟΜΟΓΕΝΗΣ",
  ΟΜΥ: "ΩΣ ΟΜΟΓΕΝΗΣ ΥΠΟΤΡΟΦΟΣ",
  ΠΑΔΕ: "ΠΑΝΕΛΛΗΝΙΕΣ ΕΞΕΤΑΣΕΙΣ (ΑΠΟΦΑΣΗ ΔΙΟΙΚΗΤΙΚΟΥ ΕΦΕΤΕΙΟΥ ΑΘΗΝΩΝ)",
  ΠΑΚ: "ΠΑΙΔΑΓΩΓΙΚΕΣ ΑΚΑΔΗΜΙΕΣ",
  ΠΑΝ: "ΠΑΝΕΛΛΗΝΙΕΣ ΕΞΕΤΑΣΕΙΣ",
  ΠΑΣ: "ΠΑΝΕΛΛΗΝΙΕΣ ΕΞΕΤΑΣΕΙΣ (ΑΠΟΦΑΣΗ ΣΥΓΚΛΗΤΟΥ)",
  ΠΚΚ: "ΠΑΝΕΛΛΗΝΙΕΣ ΕΙΔ.ΠΕΡΙΠΤ.-ΚΟΙΝΩΝ. ΚΡΙΤΗΡΙΑ",
  ΠΠΟ: "ΠΑΝΕΛΛΗΝΙΕΣ ΕΙΔΙΚΕΣ ΠΕΡΙΠΤΩΣΕΙΣ-ΠΟΛΥΤΕΚΝΟΙ",
  ΠΣΕ: "ΕΓΓΡΑΦΗ ΩΣ ΠΡΩΗΝ Π.Σ.Ε.",
  ΠΤΡ: "ΠΑΝΕΛΛΗΝΙΕΣ ΕΙΔΙΚΕΣ ΠΕΡΙΠΤΩΣΕΙΣ-ΤΡΙΤΕΚΝΟΙ",
  ΣΑΝ: "ΑΠΟ ΣΧΟΛΗ ΑΞΙΩΜΑΤΙΚΩΝ ΝΟΣΗΛΕΥΤΙΚΗΣ",
  ΣΕΙ: "ΣΕΙΣΜΟΠΛΗΚΤΟΣ",
  ΣΤΡ: "ΣΤΡΑΤΙΩΤΙΚΕΣ ΣΧΟΛΕΣ",
  ΤΕΑ: "ΤΕΚΝΑ ΑΝΑΠΗΡΩΝ",
  ΤΕΞ: "ΤΕΚΝΑ ΕΛΛΗΝΩΝ ΕΞΩΤΕΡΙΚΟΥ",
  ΤΕΠ: "ΤΕΚΝΑ ΠΟΛΥΤΕΚΝΩΝ",
  ΤΠΛ: "ΤΕΚΝΑ ΠΟΛΥΜΕΛΩΝ ΟΙΚΟΓΕΝΕΙΩΝ",
  ΤΥΞ: "ΤΕΚΝΑ ΕΛΛΗΝΩΝ ΥΠΑΛΛΗΛΩΝ ΤΟΥ ΕΞΩΤΕΡΙΚΟΥ",
  ΤΥΦ: "ΤΥΦΛΟΙ",
  ΥΑΑ: "ΥΠΟΤΡΟΦΟΣ ΑΚΑΔΗΜΙΑΣ ΑΘΗΝΩΝ",
  ΥΙΚ: "ΩΣ ΥΠΟΤΡΟΦΟΣ Ι.Κ.Υ.",
  ΥΥΕ: "ΩΣ ΥΠΟΤΡΟΦΟΣ ΥΠ.ΕΞ.",
  ΥΥΠ: "ΩΣ ΥΠΟΤΡΟΦΟΣ Υ.Π.Ε.Π.Θ",
  ΦΕΠ: "ΦΟΙΤΗΤΕΣ ΕΙΔΙΚΩΝ ΠΡΟΓΡΑΜΜΑΤΩΝ",
  ΦΠΨ: "ΕΝΤΑΞΗ ΑΠΟ Φ.Π.Ψ.",
  ΦΣΓ: "ΕΚ ΤΟΥ ΚΑΤΑΡΓΗΘΕΝΤΟΣ ΦΥΣΙΟΓΝΩΣΤΙΚΟΥ"
};
